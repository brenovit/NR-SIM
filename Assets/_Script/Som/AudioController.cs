...
public class AudioController : MonoBehaviour {
	...
	void OnEnable(){
		GerenciadorEvento.CriarEvento ("MuteMusic", MuteMusic);
		GerenciadorEvento.CriarEvento ("MuteEffect", MuteEffect);
		GerenciadorEvento.CriarEvento ("PlaySound", PlaySound);
	}

	void OnDisable(){
		GerenciadorEvento.RemoverEvento ("MuteMusic", MuteMusic);
		GerenciadorEvento.RemoverEvento ("MuteEffect", MuteEffect);
		GerenciadorEvento.RemoverEvento ("PlaySound", PlaySound);
	}
